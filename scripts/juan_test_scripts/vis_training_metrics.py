...
# default_path = "./output/gdrn/ambf_suturing/classAware_ambf_suturing_v0.0.1/metrics.json"
...
def visualize_metrics(metrics_path:str):
    ...
    my_metrics = ["loss_PM_R", "loss_centroid", "loss_coor_x", "loss_coor_y", "loss_coor_z", "loss_mask", \
                  "loss_mask_full", "loss_region","loss_z", "total_loss"]
    ...
    fig.set_size_inches(15.45,7.41)
    fig.subplots_adjust(left=0.074, bottom=0.079, right =0.964,top=0.88,wspace=0.217, hspace=0.5536)
